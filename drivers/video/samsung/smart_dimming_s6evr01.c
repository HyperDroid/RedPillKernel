...
#include "s6evr01_volt_tbl.h"

#define VALUE_DIM_1000	1000
#define VT_255_div_1000	860000
#define VREG_OUT_1000	6500
#define VREG_OUT_1000_1024		6656000
...
static const unsigned char gamma_300cd_10[] = {
	0x01, 0x27, 0x01, 0x3D, 0x01, 0x47,
	0xD1, 0xD7, 0xD1, 0xCA, 0xCE, 0xCC, 0xC4, 0xB3, 0xB1,
	0xA1, 0xB9, 0xB8, 0xA2, 0xCE, 0xBA, 0xC8, 0xC9, 0xAD,
	0x9B, 0x85, 0x53, 0x6A, 0x7E, 0xE3, 0x09, 0x09, 0x0B
};
...
static const unsigned char gamma_300cd_84[] = {
	0x01, 0x27, 0x01, 0x3D, 0x01, 0x47, 0xD1, 0xD1,
	0xCA, 0xCE, 0xCC, 0xC4, 0xB3, 0xB1, 0xA1, 0xB9,
	0xB8, 0xA2, 0xCE, 0xCE, 0xBA, 0xC8, 0xC9, 0xAD,
	0x9B, 0x85, 0x53, 0x6A, 0x7E, 0xE3, 0x09,	0x09,
	0x0B,
...
static u32 calc_v255_volt(s16 gamma, int rgb_index, u32 adjust_volt[CI_MAX][AD_IVMAX])
{
	...
	ret = volt_table_v255_ub[gamma] >> 16;
...
int init_table_info(struct str_smart_dim *smart)
{
	...
	smart->gamma_table[G_207] = GAMMA_CONTROL_TABLE[G_207];
	smart->gamma_table[G_208] = GAMMA_CONTROL_TABLE[G_208];
	smart->gamma_table[G_21] = GAMMA_CONTROL_TABLE[G_21];
	smart->gamma_table[G_212] = GAMMA_CONTROL_TABLE[G_212];
	smart->gamma_table[G_214] = GAMMA_CONTROL_TABLE[G_214];
