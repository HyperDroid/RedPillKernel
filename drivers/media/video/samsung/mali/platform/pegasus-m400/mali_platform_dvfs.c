...
mali_dvfs_step step[MALI_DVFS_STEPS]={
	...
	/*step 1 clk*/ {350,   950000},
#if (MALI_DVFS_STEPS > 2)
	/*step 2 clk*/ {440,  1025000},
...
#if (MALI_DVFS_STEPS > 1)
	{ 1025000, 1012500, 1000000,  987500,  975000,  962500,  950000,  937500,  950000,  937500,  925000,  912500},	/* L3(350Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 1087500, 1075000, 1062500, 1050000, 1037500, 1025000, 1025000, 1000000, 1012500, 1000000,  987500,  975000},	/* L2(440Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1150000, 1137500, 1125000, 1112500, 1100000, 1087500, 1075000, 1062500, 1087500, 1075000, 1062500, 1050000},	/* L1(533Mhz) */
#if (MALI_DVFS_STEPS > 4)
	{ 1250000, 1237500, 1225000, 1212500, 1200000, 1187500, 1175000, 1162500, 1187500, 1175000, 1162500, 1150000},	/* L0(733Mhz) */
#endif
#endif
#endif
#endif
...
#if CPUFREQ_LOCK_DURING_440
		/* lock/unlock CPU freq by Mali */
		if ((mali_dvfs[change_step].clock == 733) || (mali_dvfs[change_step].clock == 533))
